...
# if args.analyse:
# evaluator = model.evaluator.create('INT_cAC_noljp', cvode_active=True)
#     evaluator = model.evaluator.create('INT_cAC_noljp', cvode_active=False, dt=0.025)
# else:

evaluator = model.evaluator.create('INT_cAC_noljp', cvode_active=True, dt=0.025)
#evaluator = model.evaluator.create('INT_cAC_noljp', cvode_active=True, cvode_minstep=0.025)
