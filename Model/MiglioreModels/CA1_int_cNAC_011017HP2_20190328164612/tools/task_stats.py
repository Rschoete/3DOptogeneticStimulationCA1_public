...
def get_engine_data():
    ...
    path = '../.ipython/profile_ipyparallel.362991/tasks.db'
    #path = '/gpfs/bbp.cscs.ch/home/migliore/singlecell-optimization/CA1/PC/PC_20160315_ported/.ipython/profile_ipyparallel.374386/tasks.db'
    #path = '/gpfs/bbp.cscs.ch/home/saray/singlecell-optimization/CA1/PC/PC_20160315_ported/.ipython/profile_ipyparallel.374408/tasks.db'

    #path = "/gpfs/bbp.cscs.ch/home/lupascu/proj42/singlecell/optimization/CA1/PC/PC_20160315_ported/.ipython/profile_benchmark.355956/tasks.db"
